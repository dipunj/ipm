...
ActiveRecord::Schema.define(version: 20200719114638) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"
  enable_extension "uuid-ossp"

  create_table "admission_logs", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["admission_id"], name: "index_admission_logs_on_admission_id", using: :btree
    t.index ["bed_id"], name: "index_admission_logs_on_bed_id", using: :btree
    t.index ["created_by_id"], name: "index_admission_logs_on_created_by_id", using: :btree
    t.index ["last_updated_by_id"], name: "index_admission_logs_on_last_updated_by_id", using: :btree
    t.index ["patient_id"], name: "index_admission_logs_on_patient_id", using: :btree
  end

  create_table "admissions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.datetime "admit_timestamp",                 null: false
    t.datetime "discharge_timestamp"
    t.boolean  "is_discharged"
    t.string   "doctor_name",         limit: 255, null: false
    ...
    t.index ["bed_id"], name: "index_admissions_on_bed_id", using: :btree
    t.index ["created_by_id"], name: "index_admissions_on_created_by_id", using: :btree
    t.index ["last_updated_by_id"], name: "index_admissions_on_last_updated_by_id", using: :btree
    t.index ["patient_id", "admit_timestamp"], name: "index_admissions_on_patient_id_and_admit_timestamp", unique: true, using: :btree
  ...
  create_table "beds", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["ward_id", "name"], name: "index_beds_on_ward_id_and_name", unique: true, using: :btree
    t.index ["ward_id"], name: "index_beds_on_ward_id", using: :btree
  end
  ...
  create_table "buildings", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.index ["branch_code"], name: "index_buildings_on_branch_code", unique: true, using: :btree
  end
  ...
  create_table "patients", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.index ["name", "phone"], name: "index_patients_on_name_and_phone", unique: true, using: :btree
  end
  ...
  create_table "transactions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",                                                   null: false
    t.index ["admission_id"], name: "index_transactions_on_admission_id", using: :btree
    t.index ["created_by_id"], name: "index_transactions_on_created_by_id", using: :btree
    t.index ["reverses_transaction_id"], name: "index_transactions_on_reverses_transaction_id", using: :btree
  end
  ...
  create_table "visitor_logs", id: false, force: :cascade do |t|
    ...
    t.index ["visitor_id", "admission_id", "entry_timestamp"], name: "unique_visits", unique: true, using: :btree
  end
  ...
  create_table "visitors", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
    t.index ["name", "phone", "relation_with_patient"], name: "index_visitors_on_name_and_phone_and_relation_with_patient", unique: true, using: :btree
  end
  ...
  create_table "wards", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["building_id", "ward_type", "ward_number"], name: "index_wards_on_building_id_and_ward_type_and_ward_number", unique: true, using: :btree
    t.index ["building_id"], name: "index_wards_on_building_id", using: :btree
  end
