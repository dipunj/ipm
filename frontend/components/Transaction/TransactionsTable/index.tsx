...
import { handleSuccessToast } from '../../../library/Toaster';
...
const Transactions = (props: ITransactions): JSX.Element => {
	const { list, admission_id, refetchTransactions } = props;
	...
	return (
		<TableContainer>
			<div style={{ minHeight: '200vh' }}>
				...
				<NewTransaction {...{ newTransaction, onInputChange, handleCreate }} />
			</div>
		</TableContainer>
	);
};
